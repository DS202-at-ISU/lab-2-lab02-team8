...
ggplot(ames_clean, aes(x = `YearBuilt`, y = `Sale Price`)) +
   ...
   labs(title = "Sale Price vs Year Built",
        ...
        y = "Sale Price")
```
![](images/sale-price-vs-year-built-cleaned.png)
<br>
Fair to conclude that house price increased over time, and newly built houses are worth more, house price started increasing more rapidly starting 1980.
